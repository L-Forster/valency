    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 sm:pt-32 sm:pb-24 flex flex-col items-center justify-center text-center">
        ...
        >
          ...
          >
            Valency AI uses transformer neural networks to analyze emotional valence and arousal in text, helping businesses create more empathetic chatbot experiences.
          </motion.p>
