      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-8 h-8 bg-gradient-to-br from-deepblue-500 to-purple-500 rounded-lg flex items-center justify-center">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-100 tracking-wider uppercase mb-4">Product</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-100 tracking-wider uppercase mb-4">Resources</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-100 tracking-wider uppercase mb-4">Company</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-dark-100">
          <p className="text-center text-sm text-slate-500">
            &copy; {new Date().getFullYear()} Valency AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <Link href={href} className="text-sm text-slate-400 hover:text-slate-300 transition-colors duration-200">
        {children}
      </Link>
    </li>
  );
